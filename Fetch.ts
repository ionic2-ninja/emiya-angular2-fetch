...
export class Fetch {
  ...
  constructor(private platform: Platform, private Http: Http, private app: App) {
                ...
                if (_data != null)
                  if (remove_config[p].condition_value == null) {
                    ...
                    if (remove_config[p].redirect_to)
                      this.app.getRootNav().push(remove_config[p].redirect_to, utils.injectRedirectedParams(remove_config[p].redirect_params), remove_config[p].redirect_params_options, remove_config[p].redirect_done)
                    // setTimeout(function () {
                    //   if (remove_config[p].redirect_to) {
